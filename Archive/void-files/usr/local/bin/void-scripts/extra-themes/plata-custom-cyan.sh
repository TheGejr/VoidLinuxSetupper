...
EOF
  ...
  ./autogen.sh --prefix=/usr --enable-parallel --enable-plank --disable-gnome --disable-cinnamon --disable-mate --disable-flashback --with-selection_color=#00BCD4 --with-accent_color=#4DD0E1 --with-suggestion_color=#18FFFF --with-destruction_color=#00BCD4
