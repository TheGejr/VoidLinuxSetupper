...
EOF
  ...
  ./autogen.sh --prefix=/usr --enable-parallel --enable-plank --disable-gnome --disable-cinnamon --disable-mate --disable-flashback --with-selection_color=#673AB7 --with-accent_color=#9575CD --with-suggestion_color=#7C4DFF --with-destruction_color=#673AB7
