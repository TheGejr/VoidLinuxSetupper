...
EOF
  ...
  ./autogen.sh --prefix=/usr --enable-parallel --enable-plank --disable-gnome --disable-cinnamon --disable-mate --disable-flashback --with-selection_color=#E91E63 --with-accent_color=#F06292 --with-suggestion_color=#FF4081 --with-destruction_color=#E91E63
