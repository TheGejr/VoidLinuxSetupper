...
EOF
  ...
  ./autogen.sh --prefix=/usr --enable-parallel --enable-plank --disable-gnome --disable-cinnamon --disable-mate --disable-flashback --with-selection_color=#795548 --with-accent_color=#A1887F --with-suggestion_color=#8D6E63 --with-destruction_color=#795548
