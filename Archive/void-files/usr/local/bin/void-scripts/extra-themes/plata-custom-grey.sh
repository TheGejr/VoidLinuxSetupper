...
EOF
  ...
  ./autogen.sh --prefix=/usr --enable-parallel --enable-plank --disable-gnome --disable-cinnamon --disable-mate --disable-flashback --with-selection_color=#616161 --with-accent_color=#9E9E9E --with-suggestion_color=#757575 --with-destruction_color=#616161
