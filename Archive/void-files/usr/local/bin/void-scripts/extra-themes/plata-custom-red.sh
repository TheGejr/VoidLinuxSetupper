...
EOF
  ...
  ./autogen.sh --prefix=/usr --enable-parallel --enable-plank --disable-gnome --disable-cinnamon --disable-mate --disable-flashback --with-selection_color=#F44336 --with-accent_color=#E57373 --with-suggestion_color=#FF5252 --with-destruction_color=#F44336
