...
EOF
  ...
  ./autogen.sh --prefix=/usr --enable-parallel --enable-plank --disable-gnome --disable-cinnamon --disable-mate --disable-flashback --with-selection_color=#2196F3 --with-accent_color=#64B5F6 --with-suggestion_color=#448AFF --with-destruction_color=#2196F3
