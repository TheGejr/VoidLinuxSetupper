...
EOF
  ...
  ./autogen.sh --prefix=/usr --enable-parallel --enable-plank --disable-gnome --disable-cinnamon --disable-mate --disable-flashback --with-selection_color=#009688 --with-accent_color=#4DB6AC --with-suggestion_color=#64FFDA --with-destruction_color=#009688
