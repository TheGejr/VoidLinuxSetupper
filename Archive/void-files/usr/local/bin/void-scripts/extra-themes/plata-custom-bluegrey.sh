...
EOF
  ...
  ./autogen.sh --prefix=/usr --enable-parallel --enable-plank --disable-gnome --disable-cinnamon --disable-mate --disable-flashback --with-selection_color=#607D8B --with-accent_color=#90A4AE --with-suggestion_color=#78909C --with-destruction_color=#607D8B
