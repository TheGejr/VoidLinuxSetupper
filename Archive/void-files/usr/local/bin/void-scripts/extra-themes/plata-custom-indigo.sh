...
EOF
  ...
  ./autogen.sh --prefix=/usr --enable-parallel --enable-plank --disable-gnome --disable-cinnamon --disable-mate --disable-flashback --with-selection_color=#3F51B5 --with-accent_color=#7986CB --with-suggestion_color=#536DFE --with-destruction_color=#3F51B5
