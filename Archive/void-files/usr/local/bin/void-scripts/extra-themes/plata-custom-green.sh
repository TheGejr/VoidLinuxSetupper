...
EOF
  ...
  ./autogen.sh --prefix=/usr --enable-parallel --enable-plank --disable-gnome --disable-cinnamon --disable-mate --disable-flashback --with-selection_color=#8BC34A --with-accent_color=#AED581 --with-suggestion_color=#B2FF59 --with-destruction_color=#8BC34A
